...
class SCP(QWidget):
    ...
    def statistic(self, statistic):
        ...
        btn1.clicked.connect(lambda : textsplit(self.txt))
        statistic.btn1 = btn1
...
def textsplit(text):
        # try:
            ...
            print(numbers)
            Scalculate([int(number) for number in numbers])
        # # except Exception:
        #     QMessageBox.critical(ex, "에러", f"에러 발생: 한 종류의 구분기호와 정수만 이용해주세요", QMessageBox.Ok)
